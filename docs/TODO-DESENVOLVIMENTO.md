...
- 👤 **Você faz:**
  ...
  - [ ] Criar estrutura básica de pastas conforme planejamento
...
- 🤖 **IA desenvolve:**
  ...
  - [ ] README.md de desenvolvimento (se necessário)
...
- 👤 **Você faz:**
  - [ ] Criar conta Supabase (auto-hospedado) e configurar
  - [ ] Criar conta Stripe e obter chaves (teste e produção)
  - [ ] Criar conta Trigger.dev e configurar
  - [ ] Criar conta OpenRouter e obter API key
...
- 🤖 **IA desenvolve:**
  ...
  - [ ] Documentar cada variável no README ou arquivo específico

- 👤 **Você faz:**
  - [ ] Criar .env.local (desenvolvimento) baseado no .env.example
  - [ ] Preencher todas as variáveis com credenciais reais
